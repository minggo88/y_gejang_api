...
if (!defined('__LOADED_EXCHANGEAPI__')) {
    class ExchangeApi extends SimpleRestful
    {
         ...
         */
        public function add_wallet_txn($userno, $address, $symbol, $address_relative, $txn_type, $direction, $amount, $fee, $tax, $status="O", $key_relative="", $txndate='', $msg='', $app_no='0', $txn_method='COIN', $nft_id='') {
        ...
        public function get_currency($symbol='') {
            ...
            if($symbol) {
                ...
                $sql .= " AND symbol in ('".implode("','", array_map(array($this, 'escape'), $symbol)) ."') ";
				// $sql .= " and symbol='".strtoupper($this->escape($symbol))."' ";
			}
            //$sql .= " order by  sortno";
